...
datagen = ImageDataGenerator(
    rotation_range=180, # Rotate images by 20 degrees
...
augmented_datagen = datagen.flow(X_train, y_train, batch_size=256)
...
# Train the model
model.fit_generator(augmented_datagen, epochs=5, validation_data=(X_test, y_test))
